...
require_once('../class/common.php');
    ...
    $desc[22] = "Easily upset; Unconventional; Sensitive; A good person who lives in a fool's paradise; A dreamer of dreams, blinded by illusion and delusion, beclouded by false judgement; Great service to others but failure to please them. Lucky colours ELECTRIC COLOURS, half-shades, half-tones. Example: Moses, Obadare.";
                ...
                <div class="body-co">
                    ...
                    <form class="login-form" id="login-form" action="sendmsg.php" method="POST" style="color: #333;">
                        <div class="log-input-group">
                            ...
                            <input type="text" name="phone" style="color: #333; border: 1px solid #333;" placeholder="09039834732">
                        </div>
