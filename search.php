...
$desc[0] = "Payment not successful, kindly come back later. Thank you for using our service.";
                    ...
                    <div class="detail" id="login-form">
                        ...
                        <form class="login-form" id="login-form" action="sendmsg.php" method="POST"
                            ...
                            <div class="log-input-group">
                                ...
                                <input type="text" name="phone" style="color: #333; border: 1px solid #333;" disabled
                                    value="<?= $phone; ?>" placeholder="09039834732">
                            </div>
                            <input type="hidden" name="message" value="<?= $msg; ?>">
                            <input type="hidden" name="name" value="<?= $name; ?>">
                            <div class="log-input-group">
                                <button type="submit" disabled class="btn">Send Message</button>
                            </div>
                        </form>
                    </div>
